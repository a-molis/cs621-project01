...
lib_ob=$(src)/$(conn)/udp_socket_handler.o ext/cJSON/cJSON.o src/config/config.o src/client_server_compdetect/comp_utils.o $(src)/$(conn)/tcp_sock_handler.o
...
all: $(lib_ob) $(test_bin) $(bin) $(root_test_files)
